...
public class IO_BCCModelViewFragment extends Fragment {
    ...
    public IO_BCCModelViewFragment() {
        // Required empty public constructor
    }

    public static IO_BCCModelViewFragment newInstance(ArrayList<DMU> dmuArrayList) {
        IO_BCCModelViewFragment fragment = new IO_BCCModelViewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View root= inflater.inflate(R.layout.fragment_i_o__b_c_c_model_view, container, false);
    ...
    private void setView(View root){
        webView = (WebView) root.findViewById(R.id.web_view_IO);
    }
    private void calculateIO_BCCModel(){
        IO_BCCModel io_bccModel=new IO_BCCModel(getContext(),arrayList);
        dmuArrayList=io_bccModel.calculateIO_BCCModel();
    }
    private void setTable(View root){
        TableView tableView = new TableView(root.getContext());
        tableView=root.findViewById(R.id.table_IO);
